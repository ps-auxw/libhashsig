...
/** Function to XOR data given as bytes into the state.
  ...
  */
void hashsig_SnP_XORBytesInLane(void *state, unsigned int lanePosition, const unsigned char *data, unsigned int offset, unsigned int length);
...
/** Function to XOR data given as bytes into the state.
  ...
  */
void hashsig_SnP_XORLanes(void *state, const unsigned char *data, unsigned int laneCount);
...
/** Function to overwrite data given as bytes into the state.
  ...
  * @pre    0 ≤ @a offset + @a length ≤ (lane size in bytes)
  */
void hashsig_SnP_OverwriteBytesInLane(void *state, unsigned int lanePosition, const unsigned char *data, unsigned int offset, unsigned int length);
...
/** Function to overwrite data given as bytes into the state.
  ...
  * @pre    0 ≤ @a laneCount ≤ 25
  */
void hashsig_SnP_OverwriteLanes(void *state, const unsigned char *data, unsigned int laneCount);
...
/** Function to retrieve data from the state into bytes.
  ...
  * @pre    0 ≤ @a offset + @a length ≤ (lane size in bytes)
  */
void hashsig_SnP_ExtractBytesInLane(const void *state, unsigned int lanePosition, unsigned char *data, unsigned int offset, unsigned int length);
...
/** Function to retrieve data from the state into bytes.
  ...
  * @pre    0 ≤ @a laneCount ≤ 25
  */
void hashsig_SnP_ExtractLanes(const void *state, unsigned char *data, unsigned int laneCount);
...
/** Function to retrieve data from the state into bytes and
  ...
  * @pre    0 ≤ @a offset + @a length ≤ (lane size in bytes)
  */
void hashsig_SnP_ExtractAndXORBytesInLane(const void *state, unsigned int lanePosition, unsigned char *data, unsigned int offset, unsigned int length);
...
/** Function to retrieve data from the state into bytes and
  ...
  * @pre    0 ≤ @a laneCount ≤ 25
  */
void hashsig_SnP_ExtractAndXORLanes(const void *state, unsigned char *data, unsigned int laneCount);
