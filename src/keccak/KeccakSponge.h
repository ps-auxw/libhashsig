...
/**
  ...
  */
int hashsig_Keccak_SpongeInitialize(Keccak_SpongeInstance *spongeInstance, unsigned int rate, unsigned int capacity);
...
/**
  ...
  * @return Zero if successful, 1 otherwise.
  */
int hashsig_Keccak_SpongeAbsorb(Keccak_SpongeInstance *spongeInstance, const unsigned char *data, size_t dataByteLen);
...
/**
  ...
  * @return Zero if successful, 1 otherwise.
  */
int hashsig_Keccak_SpongeAbsorbLastFewBits(Keccak_SpongeInstance *spongeInstance, unsigned char delimitedData);
...
/**
  ...
  * @return Zero if successful, 1 otherwise.
  */
int hashsig_Keccak_SpongeSqueeze(Keccak_SpongeInstance *spongeInstance, unsigned char *data, size_t dataByteLen);
